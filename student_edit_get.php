...
{	
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM students_add WHERE id=$id");
    ...
    {
        $response['name'] = $res['student_name'];
        $response['surname'] = $res['student_surname'];
        $response['number'] = $res['student_number'];
    } 
